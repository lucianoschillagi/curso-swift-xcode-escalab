...
// Define una función que "apunta" (y almacena) el valor de un caso en particular, en este ejemplo "noche"
let momentoActual = MomentoDelDia.tarde
...
// Para algunas enumeraciones es útil tener una colección de con todos los casos de la enumeración.
